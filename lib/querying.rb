...
def select_series_title_with_most_human_characters
  ...
  GROUP BY MAX(characters.name)
  ORDER BY characters.name DESC;"
 
end

def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, books.title FROM characers
  GROUP BY Characters.name ORDER BY books DESC and ORDER BY characters.name ASC;"
